...
/***** Prgm-Includes *****/
#include "prgm_include/gui_main.h"
...
main (int argc, char *argv[])
{
  ...
  if (loading_screen == NULL)
    exit_error (_("Following graphics file could not be loaded:"), LOADING_SCREEN);
  ...
  if (get_config_int ("global", "first_start", 1) == 1)
    {
      ...
      alfont_textout_centre_aa(screen, main_font, _("Press any key..."), SCREEN_W / 2,
                               440, makecol (255, 255, 255));
      readkey ();
